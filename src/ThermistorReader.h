...
private:
	...
	double R_series = 10000; //!< Resistance of R2 in voltage divider (Ohm)
	double B = 3950;         //!< Thermistor's value of B in the thermistor equation (K)
	double r_inf = 0.01752;  //!< Thermistor's value of R_inf in the thermistor equation (Ohm)
